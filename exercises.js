...
function daClub(cover, age){
  if (cover >= 21 && age >= 21){
    ...
    "Chuck E Cheese is across the street.";
  }
}
...
console.log(graduation(120, 1.9))
...
function moneyTrain(speed){
  if (speed < 50){
    ...
    return "Now you are ballin' in the Shinkansen!";
  }
  }
